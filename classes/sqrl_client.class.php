...
/**
 * A class to encompass the processing and validation of incomming
 ...
 * @link   
 */
class sqrl_client extends sqrl_common implements sqrl_client_api
{
...
/*
    public function __construct()
    {
        ...
        $this->post = $_POST;
        //process post array
        $this->vars = $this->process();
        //returned processed but yet unvalidated
        return $this;
    }
*/    
    /**
