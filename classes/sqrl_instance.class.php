 ...
 * This is a better option than dependancy injection.
 * NB: Implementors on other platforms can place their own override
 * clases and use the class name as the call instead of any default.
